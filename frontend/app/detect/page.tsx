  ...
  return (
    <>
      <div className='flex flex-wrap justify-between w-4/5'>
        ...
        <section className='w-1/2 max-md:w-full mb-10 bg-whitehue-600 dark:bg-whitehue-800 rounded-2xl dark:mix-blend-color-dodge p-8 shadow-2xl shadow-bg-whitehue-900 dark:shadow-coldHeights-700'>
          ...
          <div className='mt-5'>
            ...
            <div className='flex justify-between mt-5'>
              ...
              <button className='bg-coldHeights-400 w-1/3 rounded-lg ml-2' onClick={handleFileUpload}>Run</button>
            </div>
